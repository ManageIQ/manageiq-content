...
#
# Description: This method is used to email the requester and approver that the Transformation Plan request has been denied
#
...
def approver_denied_text(requester_email, msg, reason)
  body = "<br>A Transformation Plan request received from #{requester_email} was denied."
  body += "<br><br>#{msg}."
...
def email_approver(appliance, msg)
  ...
  subject = "Request ID #{@miq_request.id} - Transformation Plan request was denied"
