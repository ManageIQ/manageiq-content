#
# Description: This method is used to email the Transformation Plan requester that
# the Transformation Plan request has been approved
#
...
def emailrequester(miq_request, appliance)
  ...
  # Build email body
  body = "Hello, "
  body += "<br>Your Transformation Plan request was approved. If Transformation Plan is successful you will be notified via email when the Service is available."
...
def emailapprover(miq_request, appliance)
  ...
  # Build email body
  body = "Approver, "
  body += "<br>Transformation Plan request received from #{requester_email} was approved."
