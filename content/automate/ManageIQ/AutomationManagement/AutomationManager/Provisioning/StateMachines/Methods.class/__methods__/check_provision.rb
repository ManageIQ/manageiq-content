          ...
          module StateMachines
            module Methods
              class CheckProvision
                ...
                def main
                  task = @handle.root['miq_provision_task']
                  result = task.statemachine_task_status
                  server = task.source
                  server_str = "AutomationManager id=#{server.id} ems_ref=#{server.ems_ref}"
...
ManageIQ::Automate::AutomationManagement::AutomationManager::Provisioning::StateMachines::Methods::CheckProvision.new.main
