#
# Description: This method is used to email the reconfigure requester that
# the Service reconfigure request has been approved
#
...
def emailrequester(miq_request, appliance)
  ...
  # Build subject
  subject = "Request ID #{miq_request.id} - Your Service reconfigure request was Approved"

  # Build email body
  body = "Hello, "
  body += "<br>Your Service reconfigure request was approved. If Service reconfiguration is successful you will be notified via email."
...
def emailapprover(miq_request, appliance)
  ...
  # Build email body
  body = "Approver, "
  body += "<br>Service reconfigure request received from #{requester_email} was approved."
