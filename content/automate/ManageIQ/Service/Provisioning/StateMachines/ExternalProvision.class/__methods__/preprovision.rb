#
# Description: This method prepares arguments and parameters for external provisioning
#
module ManageIQ
  module Automate
    module Service
        ...
        module StateMachines
          module ExternalProvision
            class PreProvision
              ...
              def main
                @handle.log("info", "Starting External Pre-Provisioning")
...
if __FILE__ == $PROGRAM_NAME
  ManageIQ::Automate::Service::Provisioning::StateMachines::ExternalProvision::PreProvision.new.main
end
