...
describe ManageIQ::Automate::System::Notification::Email::MiqProvisionTemplateCustomizeBody do
  ...
  it "No Retirement will be retired in Body" do
    ...
    described_class.new(ae_service).main
    expect(ae_service.object['body']).to include('Your request to publish from template was approved and completed')
  end
